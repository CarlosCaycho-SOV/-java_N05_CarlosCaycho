...
public class FormAlumnos extends javax.swing.JFrame {
    ...
    public FormAlumnos() {
       ...
       // CConexion objetocon = new CConexion();
        //objetocon.EstablecerConexion();
        CAlumnos mostrar = new CAlumnos();
        mostrar.MostrarAlumnos(tbTablaAlumnos);
    }
    ...
    private void initComponents() {
        ...
        setTitle("CRUD DE MAESTRO");
        setBackground(new java.awt.Color(0, 0, 0));

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Panel Alumnos"));
        ...
        jButton1.setText("Registrar Otros Datos");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Tabla Alumnos"));
    ...
    private void btnmodificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmodificarActionPerformed
        CAlumnos modificar = new CAlumnos();
        modificar.modificarAlumnos(txtId, txtNombres, txtApellidos);
        modificar.MostrarAlumnos(tbTablaAlumnos);
    }//GEN-LAST:event_btnmodificarActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        CAlumnos objetointo = new CAlumnos();
        objetointo.InsertarAlumno(txtNombres, txtApellidos);
        CAlumnos mostrar = new CAlumnos();
        mostrar.MostrarAlumnos(tbTablaAlumnos);
    ...
    private void tbTablaAlumnosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbTablaAlumnosMouseClicked
         CAlumnos objetointo = new CAlumnos();
         objetointo.SelecionAlumno(tbTablaAlumnos, txtId, txtNombres, txtApellidos);
    }//GEN-LAST:event_tbTablaAlumnosMouseClicked

    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
 CAlumnos modificar = new CAlumnos();
        modificar.EliminarAlumno(txtId);
        modificar.MostrarAlumnos(tbTablaAlumnos);       
